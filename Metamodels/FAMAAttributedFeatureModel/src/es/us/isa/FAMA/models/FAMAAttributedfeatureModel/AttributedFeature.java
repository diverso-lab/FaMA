...
public class AttributedFeature extends GenericAttributedFeature{
	...
	public AttributedFeature (String name) {
	...
	public AttributedFeature(String name, Collection<GenericAttribute> atts){
		this(name);
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof AttributedFeature) {
			AttributedFeature f = (AttributedFeature)obj;
...
//		}
	...
	public String fmToString(){
		...
		while (it.hasNext()){
			...
			Iterator<AttributedFeature> itFeats = aux.getDestination();
			while (itFeats.hasNext()){
				AttributedFeature f = itFeats.next();
				res+=f.fmToString();
			}
		}
		return res;
