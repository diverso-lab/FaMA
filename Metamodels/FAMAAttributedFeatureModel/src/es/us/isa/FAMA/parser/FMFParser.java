...
public class FMFParser {
	...
	public FAMAAttributedFeatureModel parseModel(String path) {
		...
		FAMAAttributedFeatureModel res = null;
	...
	public FAMAAttributedFeatureModel parseModelFromString(String s) {
		FAMAAttributedFeatureModel res = null;
	...
	private FAMAAttributedFeatureModel parseModel(Anasint as) {
		FAMAAttributedFeatureModel res = null;
		try {
...
//			frame.setVisible(true);
	...
	public static void main(String[] args) {
		...
		FAMAAttributedFeatureModel fm = parser.parseModel(args[0]);
