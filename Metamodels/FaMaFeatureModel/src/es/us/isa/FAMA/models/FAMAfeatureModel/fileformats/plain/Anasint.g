...
constraint:  (exclusion | inclusion | declaracion_expresion) PyC!;
...
declaracion_expresion: e:expresion {## = constraintExpresion(#e);};
...
exp_base: b:IDENT {resuelveNombre(#b);}//feature, o atributo dentro de una invariante
