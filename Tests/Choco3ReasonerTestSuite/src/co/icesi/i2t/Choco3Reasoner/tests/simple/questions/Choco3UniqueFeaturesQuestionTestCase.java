...
/**
 * Test case for the Unique Features question in the Choco 3 Reasoner.
 * 
 * @author Andrés Paz, I2T Research Group, Icesi University, Cali - Colombia
 * @version 1.0, October 2014
 */
public class Choco3UniqueFeaturesQuestionTestCase extends
	 ...
	 * Question name
	 */
	private static final String QUESTION = "UniqueFeatures";
	
	public Choco3UniqueFeaturesQuestionTestCase(String variabilityModelPath,
	...
	/**
	 * Test method for {@link co.icesi.i2t.Choco3Reasoner.simple.questions.Choco3UniqueFeaturesQuestion#getUniqueFeatures()}.
	 */
	@Test
	public void testGetUniqueFeatures() {
		...
		if (choco3UniqueFeaturesQuestion != null) {
			try {
				...
				if (!expectedOutput.equals("")) {
					...
					ArrayList<GenericFeature> expectedUniqueFeatures = new ArrayList<GenericFeature>();
					for (int i = 0; i < expectedOutputs.length; i++) {
						Feature expectedUniqueFeature = new Feature(expectedOutputs[i]);
						expectedUniqueFeatures.add(expectedUniqueFeature);
					}
					Collections.sort(expectedUniqueFeatures, comparator);
