...
inputState.guessing--;
	...
	public final void lista_constraints() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			_loop800:
			do {
				if ((LA(1)==IDENT||LA(1)==NOT||LA(1)==PARENTESIS_ABRIR)) {
					constraint();
					astFactory.addASTChild(currentAST, returnAST);
				}
				else {
	...
	public final void constraint() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			else if ((LA(1)==IDENT||LA(1)==NOT||LA(1)==PARENTESIS_ABRIR) && (_tokenSet_7.member(LA(2)))) {
	...
	private static final long[] mk_tokenSet_7() {
		long[] data = { 1082356924416L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_7 = new BitSet(mk_tokenSet_7());
	private static final long[] mk_tokenSet_8() {
		long[] data = { 824650498050L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_8 = new BitSet(mk_tokenSet_8());
	private static final long[] mk_tokenSet_9() {
		long[] data = { 1099520016384L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_9 = new BitSet(mk_tokenSet_9());
	private static final long[] mk_tokenSet_10() {
		long[] data = { 1151059623936L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_10 = new BitSet(mk_tokenSet_10());
	private static final long[] mk_tokenSet_11() {
		long[] data = { 1219779100672L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_11 = new BitSet(mk_tokenSet_11());
	private static final long[] mk_tokenSet_12() {
		long[] data = { 1357218054144L, 0L};
		return data;
	}
