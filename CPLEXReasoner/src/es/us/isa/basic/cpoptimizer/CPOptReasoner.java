package es.us.isa.basic.cpoptimizer;
...
public class CPOptReasoner extends FeatureModelReasoner {
...
//			configs.push(configConstraint);
	...
	@Override
	public void addCardinality(GenericRelation rel,
	...
	@Override
	public void addExcludes(GenericRelation rel,
			GenericFeature origin,
...
//	}
	...
	private void createFeature(GenericFeature feature,
			Collection<Cardinality> cards) {
	...
	@Override
	public void addMandatory(GenericRelation rel,
			GenericFeature child, GenericFeature parent) {
	...
	@Override
	public void addOptional(GenericRelation rel,
			GenericFeature child, GenericFeature parent) {
		IloIntVar childV = featureVars.get(child.getName());
		IloIntVar parentV = featureVars.get(parent.getName());
		try {
	...
	@Override
	public void addRequires(GenericRelation rel,
			GenericFeature origin,
			GenericFeature destination) {
		IloIntVar originV = featureVars.get(origin.getName());
		IloIntVar targetV = featureVars.get(destination.getName());
	...
	@Override
	public void addSet(GenericRelation rel,
