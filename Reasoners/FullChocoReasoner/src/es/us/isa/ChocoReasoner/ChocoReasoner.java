...
//				new RandomIntVarSelector(null));
	...
	public void addConstraint(es.us.isa.FAMA.models.featureModel.Constraint c) {
		Constraint chocoConstraint = chocoParser.translateToConstraint(c.getAST());
		this.dependencies.put(c.getName(), chocoConstraint);
		this.problem.addConstraint(chocoConstraint);
	}
