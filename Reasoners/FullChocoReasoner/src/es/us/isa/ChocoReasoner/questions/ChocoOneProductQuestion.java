...
public class ChocoOneProductQuestion extends ChocoQuestion implements
	...
	Random r = new Random();
	long seedVar = r.nextLong();
	long seedVal = r.nextLong();
	...
	public PerformanceResult answer(Reasoner choco) {
		...
		solver.setValIntSelector(new RandomIntValSelector(seedVal));
		solver.setVarIntSelector(new RandomIntVarSelector(solver, seedVar));
