...
/* This example shows how to generate a customized feature model specifying a number of input constraints. It also shows how to
 * make the generation reproducible by using a 'seed' and how to obtain detailed statistics of the model generated.
 */

public class RandomFMGeneration3 {
	...
	public static void main(String[] args) throws Exception, BettyException {
		...
		// OPTIONAL: Save the seed for making the generation reproducible. 
		//This can be set in a later generation as characteristics.setSeed();
		...
		writer.saveFM(fm, "./model.fm"); // Other valid formats: .splx, .fm, .dot
