...
import jmetal.metaheuristics.dmopso.DMOPSOAAFM;
 ...
 */
public class dMOPSOAAFM_Settings extends AAFMSettings {
	 ...
	 * Constructor
	 */
	public dMOPSOAAFM_Settings(AAFMProblem problem) {
		super(problem);
	...
	public Algorithm configure() throws JMException {
		...
		algorithm = new DMOPSOAAFM(problem_) ;
