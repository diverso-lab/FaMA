...
import jmetal.metaheuristics.nsgaII.NSGAIIAAFM;
 ...
 */
public class NSGAIIAAFM_Settings extends AAFMSettings {
   ...
   * Constructor
   */
  public NSGAIIAAFM_Settings(AAFMProblem problem) {
    super(problem) ;
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new NSGAIIAAFM(problem_) ;
