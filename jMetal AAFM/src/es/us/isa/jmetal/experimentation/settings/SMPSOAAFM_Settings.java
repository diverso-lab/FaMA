...
import jmetal.metaheuristics.smpso.SMPSOAAFM;
 ...
 */
public class SMPSOAAFM_Settings extends AAFMSettings{
   ...
   * Constructor
   */
  public SMPSOAAFM_Settings(AAFMProblem problem) {
    super(problem) ;
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new SMPSOAAFM(problem_) ;
