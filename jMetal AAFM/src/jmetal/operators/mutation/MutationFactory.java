...
import jmetal.operators.mutation.integer.IntPolynomialMutation;
...
public class MutationFactory {
  ...
  public static Mutation getMutationOperator(String name, HashMap parameters) throws JMException{
    ...
    else if (name.equalsIgnoreCase("IntNonUniformMutation"))
        return new IntNonUniformMutation(parameters);
    else if (name.equalsIgnoreCase("IntPolynomialMutation"))
        return new IntPolynomialMutation(parameters);
    else if (name.equalsIgnoreCase("IntUniformMutation"))
        return new IntUniformMutation(parameters);
    else
    {
