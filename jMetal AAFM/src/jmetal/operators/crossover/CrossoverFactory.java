...
import jmetal.operators.crossover.integer.IntBLXAlphaCrossover;
import jmetal.operators.crossover.integer.IntDifferentialEvolutionCrossover;
import jmetal.operators.crossover.integer.IntSBXCrossover;
import jmetal.util.Configuration;
import jmetal.util.JMException;

import java.util.HashMap;

//XXX modified to include the new int crossovers
...
public class CrossoverFactory {
  ...
  public static Crossover getCrossoverOperator(String name, HashMap parameters) throws JMException {
    ...
    else if (name.equalsIgnoreCase("IntBLXAlphaCrossover"))
    	return new IntBLXAlphaCrossover(parameters);
    else if (name.equalsIgnoreCase("IntDifferentialEvolutionCrossover"))
    	return new IntDifferentialEvolutionCrossover(parameters);
    else if (name.equalsIgnoreCase("IntSBXCrossover"))
    	return new IntSBXCrossover(parameters);
    else {
