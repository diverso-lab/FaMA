...
public class IntSBXCrossover extends Crossover {

	  /**
	   * EPS defines the minimum difference allowed between real values
	   */
	//TODO be careful with this value. it may be non-optimal for int solutions
	   ...
	   */
	  public IntSBXCrossover(HashMap<String, Object> parameters) {
	  	super (parameters) ;
	      ...
	      for (i=0; i<numberOfVariables; i++){
	        ...
	        if (PseudoRandom.randDouble()<=0.5 ){
	          if (java.lang.Math.abs(valueX1- valueX2) > EPS){
	            ...
	            if (PseudoRandom.randDouble()<=0.5) {
	              offs1.setValue(i, (int)Math.round(c2)) ;
	              offs2.setValue(i, (int)Math.round(c1)) ;
	            } else {
	              offs1.setValue(i, (int)Math.round(c1)) ;
	              offs2.setValue(i, (int)Math.round(c2)) ;
	            } // if
	          } else {
	            offs1.setValue(i,(int)Math.round(valueX1)) ;
	            offs2.setValue(i, (int)Math.round(valueX2)) ;
	          } // if
	        } else {
	          offs1.setValue(i, (int)Math.round(valueX2)) ;
	          offs2.setValue(i, (int)Math.round(valueX1)) ;
	        } // if
	      } // if
	    } // if
