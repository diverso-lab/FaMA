...
public class IntBLXAlphaCrossover extends Crossover {
	 ...
	 */
	public IntBLXAlphaCrossover(HashMap<String, Object> parameters) {
		super (parameters) ;
	...
	public Solution[] doCrossover(double probability, 
        ...
        if (valueY1 < lowerValue)
        	offs1.setValue(i, (int)Math.round(lowerValue)) ;
        else if (valueY1 > upperValue)
        	offs1.setValue(i, (int)Math.round(upperValue));
        else
        	offs1.setValue(i, (int)Math.round(valueY1));

        if (valueY2 < lowerValue)
        	offs2.setValue(i, (int)Math.round(lowerValue)) ;
        else if (valueY2 > upperValue)
        	offs2.setValue(i, (int)Math.round(upperValue)) ;
        else
        	offs2.setValue(i, (int)Math.round(valueY2)) ;
			} // if
		} // if
