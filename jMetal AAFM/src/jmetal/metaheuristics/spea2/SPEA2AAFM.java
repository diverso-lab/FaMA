 ...
 */
public class SPEA2AAFM extends AlgorithmWithSeeds{
  ...
  */
  public SPEA2AAFM(Problem problem) {                
    super(problem) ;
  } // Spea2
  ...
  public SolutionSet execute() throws JMException, ClassNotFoundException {   
    ...
    while (evaluations < maxEvaluations){               
      ...
      while (offSpringSolutionSet.size() < populationSize){           
        ...
        } while (j < SPEA2AAFM.TOURNAMENTS_ROUNDS); // do-while                    
        int k = 0;
        do{
          k++;                
          parents[1] = (Solution)selectionOperator.execute(archive);
        } while (k < SPEA2AAFM.TOURNAMENTS_ROUNDS); // do-while
