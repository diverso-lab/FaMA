 ...
 */
public class SMPSOAAFM extends AlgorithmWithSeeds {
   ...
   */
  public SMPSOAAFM(Problem problem) {
    super(problem) ;
   ...
   * @param problem Problem to solve
   */
  public SMPSOAAFM(Problem problem, String trueParetoFront) throws FileNotFoundException {
    super(problem) ;
    hy_ = new Hypervolume();
    jmetal.qualityIndicator.util.MetricsUtil mu = new jmetal.qualityIndicator.util.MetricsUtil();
    trueFront_ = mu.readNonDominatedSolutionSet(trueParetoFront);
  ...
  public SolutionSet execute() throws JMException, ClassNotFoundException {
    ...
    while (iteration_ < maxIterations_) {
      try {
        ...
        Logger.getLogger(SMPSOAAFM.class.getName()).log(Level.SEVERE, null, ex);
      }
