...
public class SMPSOInteger extends Algorithm {
	   ...
	   */
	  public SMPSOInteger(Problem problem) {
	    super(problem) ;
	   ...
	   * @param problem Problem to solve
	   */
	  public SMPSOInteger(Problem problem, String trueParetoFront) throws FileNotFoundException {
	    super(problem) ;
	    hy_ = new Hypervolume();
	    jmetal.qualityIndicator.util.MetricsUtil mu = new jmetal.qualityIndicator.util.MetricsUtil();
	    trueFront_ = mu.readNonDominatedSolutionSet(trueParetoFront);
