 ...
 */
public class MOCHCAAFM extends AlgorithmWithSeeds {

  /**
  * Constructor
  * Creates a new instance of MOCHC 
  */
  public MOCHCAAFM(Problem problem) {
    super (problem) ;
  }
  ...
  */  
  public SolutionSet execute() throws JMException, ClassNotFoundException {
	...
	for (Solution auxSol:seeds){
		Solution s = this.processSeed(auxSol);
		this.evaluate(s);
		evaluations++;
		solutionSet.add(s);
	}
