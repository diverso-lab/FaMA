...
public class JacopFeatureModelSolverAS {
	...
	private JacopResultAS results = new JacopResultAS();

	public JacopFeatureModelSolverAS(JacopFeatureModelAS fm, Filter filter, Controller c) {
	...
	public void getOneSolution(JacopFeatureModelAS fm, Filter filter) {
		this.getOneSolutionFlush(fm, false,filter);
	}

	public void getOneSolutionFlush(JacopFeatureModelAS fm, boolean flush,Filter filter) {
		...
		// Show results
		System.out.println("=========== Jacop AS:One Solution ===========");
	...
	public void getNumberOfSolutions(JacopFeatureModelAS fm, Filter filter) {
		...
		// Show results
		System.out.println("=========== Jacop AS:Number of Solutions ===========");
		System.out.println("NUMBER OF SOLUTIONS: " + res);
		System.out.println("TIME TO GET THE NUMBER OF SOLUTIONS: " + time);
	}
	
	
	public void  getAllSolutions(JacopFeatureModelAS fm, Filter filter) {
	...
	// Create the problem
	private void createCSP(JacopFeatureModelAS fm,Filter filter, Controller mc) {
		...
		this.results.setNumberAtomicSets(fm.getAtomicSets());
	...
	public JacopResultAS getResults() {
		return results;
	}
