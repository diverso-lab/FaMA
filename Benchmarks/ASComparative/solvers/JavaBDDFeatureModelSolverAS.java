...
public class JavaBDDFeatureModelSolverAS {

	private BDDResultAS results=new BDDResultAS();    // Results
	private JavaBDDFeatureModelAS fm;
	private BDD bdd;							  // BDD
	private String experimentName;		 		  // Experiment Name
	
	public JavaBDDFeatureModelSolverAS(JavaBDDFeatureModelAS fm, String experimentName, Filter filter,Controller c) {
		this.fm=fm;
	...
	public void getOneSolution() {
		...
		// Show results
		System.out.println("=========== BDD AS:One Solution ===========");
	...
	public void getNumberOfSolutions() {
		...
		// Show results
    	System.out.println("=========== BDD AS:Number of Solutions ===========");
	...
	public void getAllSolutions() {
		...
		*/
    	...
    	// Show results
    	System.out.println("=========== BDD AS:All Solutions ===========");
	...
	private void createBDD(Filter filter, Controller c) {
		...
		this.results.setAtomicSets(fm.getAtomicSets());
