...
public class JacopResultAS implements IResult {
	...
	public Map<String,List> getNumberAtomicSets() {
		return as;
	}
	
	public void setNumberAtomicSets(Map<String,List> nas) {
		this.as = nas;
	}
